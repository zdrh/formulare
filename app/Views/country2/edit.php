...
<h1>Edit country</h1>
<div class="row">
    <form action="<?= base_url('form-basic-undelete/country/update') ?>" method="post">
        <div class="col-md-10">
            ...
            if ($isDeleted) {
            ?>
                <button type="submit" class="ms-2 btn btn-primary" name="action" value="restore">Send and Restore</button>
            <?php
            }
            ?>
