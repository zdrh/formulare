...
<h1>Přehled států</h1>
<?= anchor('form-alert/country/add', 'Přidat stát', ['class' => 'btn btn-primary mb-3']) ?>
<div class="row">
    <?php
    /** @var array $countries */
            ...
            <div class="card h-100 overflow-hidden">
                ...
                <div class="card-footer bg-transparent border-0 mt-auto">
                    <div class="d-flex gap-2">
                        <a href="<?= base_url('form-alert/country/edit/' . $row->id) ?>" class="btn btn-warning w-100 border border-dark">Edit</a>
...
<!-- vyžití helperu na modal -->
        <?= form_modal_delete('delModal' . $row->id, $row->id, "Delete country", "Opravdu chceš smazat stát " . $row->name, "form-alert/country/delete/" . $row->id, "danger", "Delete") ?>
    <?php
    }
    ?>
</div>
